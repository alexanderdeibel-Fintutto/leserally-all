...
export const PRICING_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    priceMonthly: 9.99,
    priceYearly: 99.90,
    priceIdMonthly: 'price_1RR06oQMeVpqz0EfJ5lv2Oui',
    priceIdYearly: 'price_1RR06oQMeVpqz0EfZ4bEDVNh',
    productId: 'prod_SMLxFhN1UXXcpu',
    features: [
      'Bis zu 10 Einheiten',
      'OCR-Zählererfassung',
      'E-Mail Support',
  ...
  },
  {
    ...
    priceMonthly: 24.99,
    priceYearly: 249.90,
    priceIdMonthly: 'price_1RR07PQMeVpqz0EfmYx3AYXh',
    priceIdYearly: 'price_1RR07PQMeVpqz0Ef0YVXMTkW',
    productId: 'prod_SMLyGowV6FLmFZ',
    features: [
      'Bis zu 50 Einheiten',
      'OCR-Zählererfassung',
      'Prioritäts-Support',
  ...
  },
  {
    ...
    priceMonthly: 79.00,
    priceYearly: 790.00,
    priceIdMonthly: 'price_1RR07yQMeVpqz0EfuHCKnQ8A',
    priceIdYearly: 'price_1RR07yQMeVpqz0EfDUcTLmFR',
    productId: 'prod_SMLzRsOQJ8SHFw',
    features: [
